...
\vspace{1em}
Setup basic servo movements with a timing schedule. Created code that ran servo through ESP32C3 board. Fixed timing schedule of servo and made it run on a finite loop. Fixed breadboard simplifying wiring and increasing functionality, added color coded wiring for the flex sensors and fixed outliers in resistors. Added servo capability into breadboard with color coded wiring. Connected second servo to breadboard and sourced parts from BELS. Adapted code to be able to run second servo.
