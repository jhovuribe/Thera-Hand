...
\vspace{1em}
Setup basic servo movements with a timing schedule. Created code that ran servo through ESP32C3 board. Fixed timing schedule of servo and made it run on a finite loop. Fixed breadboard simplifying wiring and increasing functionality. Added servo capability into breadboard with color coded wiring.
